...
import {
    ...
    ObsDashboardAudioLevels,
    ObsTwitchAudioLevels,
    ObsPreviewImg,
    ObsStreamMode,
    OmnibarMessages,
    OriBingoboard,
...
interface StoreTypes {
    ...
    obsDashboardAudioLevels: ObsDashboardAudioLevels,
    obsTwitchAudioLevels: ObsTwitchAudioLevels,
...
export const store = new Vuex.Store<StoreTypes>({
    state: {
        ...
        obsDashboardAudioLevels: {} as ObsDashboardAudioLevels,
        obsTwitchAudioLevels: {} as ObsTwitchAudioLevels,
