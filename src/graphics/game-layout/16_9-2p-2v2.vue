    ...
    <div id="GameLayout">
        ...
        <div id="team1" :style="{'border': '5px var(--border-color-' + teamColor1 + ') solid'}">
            <team-info
                ...
                id="ti1"
            ></team-info>
            <player-info id="pi1" playerIndex="0" hide-finish-time="true"
                         show-color="false" height=40px></player-info>
            <player-info id="pi2" playerIndex="1" hide-finish-time="true"
                         show-color="false" height=40px></player-info>
        </div>
        <div id="team2" :style="{'border': '5px var(--border-color-' + teamColor2 + ') solid'}">
            <team-info
                ...
                id="ti2"
            ></team-info>
            <player-info id="pi3" playerIndex="2" hide-finish-time="true"
                         show-color="false" height=40px></player-info>
            <player-info id="pi4" playerIndex="3" hide-finish-time="true"
                         show-color="false" height=40px></player-info>
        </div>
